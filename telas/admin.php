...
<body class="body3">
    <div class="container3">
        <div class="menu">
            ...
            <br/>
            <a class="menuF" href="../users/verUsuarios.php">Usuários Ativos</a>
            ...
            <div class="dropdown ml-5">
                ...
                <ul class="dropdown-menu w-100" aria-labelledby="dropdownMenuButton1">
                    ...
                    <li><a class="dropdown-item text-white" href="fechados.php"><i class="fas fa-angle-right"></i>Fechados</a></li>
                </ul>
            </div>
        ...
        <div class="header3">
            <nav class="navbar navbar-light bg-light">
                <div class="container-fluid" id="procurar">
                    ...
                    <form class="d-flex">
                        <input class="form-control me-2" type="search" placeholder="Pesquisar" aria-label="Search" id="pesquisar" data-table="1">
        ...
        <div id="admin_table" class="tabela3">
    ...
    <script type="text/javascript" src="../requisicao/requestTicket.js"></script>
