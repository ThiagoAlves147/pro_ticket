...
<body class="body3">
    <div class="container3" id="atendente">
        <div class="menu">
        <img src="../imagens/LOGO1.png" width="100%"/>
            <br/>
            ...
            <div class="dropdown ml-5">
                ...
                <ul class="dropdown-menu w-100" aria-labelledby="dropdownMenuButton1">
                    <li><a class="dropdown-item text-white" href="atendente.php"><i class="fas fa-angle-right"></i>Abertos<span class="badge bg-danger"><?= $open ?></span></a></li>
                    <li><a class="dropdown-item text-white" href="atendenteP.php"><i class="fas fa-angle-right"></i>Pendentes<span class="badge bg-danger"><?= $pendentes ?></span></a></li>
                    <li><a class="dropdown-item text-white" href="atendenteF.php"><i class="fas fa-angle-right"></i>Fechados</a></li>
                </ul>
            </div>
        ...
        <div class="tabela3">
            <?php 
                require "../tickets/verFechados.php"; 
            ?>
        </div>
