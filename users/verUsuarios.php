                    ...
                    <?php foreach($lista as $dados):?>
                        <tr>
                            ...
                            <td>
                                ...
                                |
                                <a href="deletarUser.php?id=<?php echo $dados['idUsuario'] ?>" onclick="return confirm('Certeza que deseja inativar este usuário?')"><i class="far fa-trash-alt"></i></a>
                            </td>
                        </tr>
